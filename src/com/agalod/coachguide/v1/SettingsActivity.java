		...
		OnSharedPreferenceChangeListener
{
	...
	private void setupSimplePreferencesScreen()
	{
		...
		fakeHeader.setTitle("Localization Settings");
...
// @Override
// public bool onPreferenceChanged(Preference preference, Object newValue)
// {
...
// }
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key)
	{
		...
		if (key == "source_list")
			Toast.makeText(this, "Updating place data base", Toast.LENGTH_LONG).show();

		if (key.contains("Min"))
			Toast.makeText(this, "Updating location listener", Toast.LENGTH_LONG).show();
...
// ringtone).
						...
						{
							Ringtone ringtone =
									RingtoneManager.getRingtone(preference.getContext(),
